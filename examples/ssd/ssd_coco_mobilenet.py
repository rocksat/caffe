...
from caffe.mobilenet import MobileNetBody
...
model_name = "MobileNet_coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/MobileNet/coco/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/MobileNet/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/MobileNet/coco/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/{}/data/coco/results/{}".format(os.environ['HOME'], 'Workspace', job_name)
...
# conv9_2 ==> 2 x 2
# conv10_2 ==> 1 x 1
mbox_source_layers = ['conv5_5/sep', 'conv6/sep', 'conv7_2', 'conv8_2', 'conv9_2', 'conv10_2']
# in percent %
min_ratio = 15
max_ratio = 90
